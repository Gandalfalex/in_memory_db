...
func (db *DB) saveSnapshot() error {
	...
	if err := kvtypes.WriteUint32(w, snapshotVersion); err != nil {
		return err
	}
	if err := kvtypes.WriteUint32(w, db.active.id); err != nil {
		return err
	}
	if err := kvtypes.WriteUint64(w, uint64(db.active.size)); err != nil {
		return err
	}
	if err := kvtypes.WriteUint64(w, uint64(db.idx.len())); err != nil {
		return err
	}
...
func loadSnapshotInto(dir string, idx *index) (watermarkSegID uint32, watermarkSize int64, err error) {
	...
	watermarkSegID, err = kvtypes.ReadUint32(r)
	if err != nil {
		return 0, 0, err
	}
	sizeU64, err := kvtypes.ReadUint64(r)
	if err != nil {
		return 0, 0, err
	}
	...
	for range count {
		...
		segID, err := kvtypes.ReadUint32(r)
		if err != nil {
			return 0, 0, err
		}
		valOffset, err := kvtypes.ReadUint32(r)
		if err != nil {
			return 0, 0, err
		}
		valLen, err := kvtypes.ReadUint32(r)
		if err != nil {
			return 0, 0, err
		}
