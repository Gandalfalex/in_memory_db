...
func assembleSidx(sidxPath, bodyPath string, count int64, entriesCRC uint32) error {
	...
	if err := writeUint32(bw, sidxVersion); err != nil {
		return err
	}
	if err := writeUint64(bw, uint64(count)); err != nil {
		return err
	}
...
func writeSparseFile(path string, sparse []sparseEntry) error {
	...
	if err := writeUint32(w, sidxVersion); err != nil {
		return err
	}
	if err := writeUint64(w, uint64(len(sparse))); err != nil {
		return err
	}
